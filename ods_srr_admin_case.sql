...
AGENCY_NAME,
CUSTOMER_REP,
CASE WHEN OWNER_NAME_1 IS NULL THEN OWNER_NAME_2 ELSE OWNER_NAME_1 END AS OWNER_NAME,
case when ROLE_NAME is null then owner_name_1 else role_name end as role_name,
CALLER_BUS_ID,
CONTACT_TYPE_BUS_ID,
AGENCY_BUS_ID,
CUSTOMER_REP_BUS_ID,
OWNWER_NAME_BUS_ID,
case when role_name_bus_id is null then ownwer_name_bus_id else role_name_bus_id end as role_name_bus_id,
type,
SUBJECT,
CASENUMBER,
STATUS,
...
A.OWNERID AS OWNWER_NAME_BUS_ID,
E.NAME AS OWNER_NAME_1,
g.name as owner_name_2,
...
A.CLOSEDDATE,
A.SUBJECT,
cast(A.CASENUMBEr as integer) as casenumber,
A.STATUS,
...
LEFT JOIN DM_ODS.ODS_SRR_GROUPS E ON A.OWNERID = E.GROUPID
LEFT JOIN DM_ODS.ODS_PROFILE_USER G ON A.OWNERID = G.USERID
left JOIN DM_ODS.ODS_PROFILE_USERROLE F ON g.userroleid=F.ID
WHERE 
