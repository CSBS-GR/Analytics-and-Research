...
,L.QUESTION_REPORT_GROUP_DESC AS REPORT_GROUP
...
left join LK_PF_QUESTION_REPORT_GROUP L on C.QUESTION_REPORT_GROUP_ID = L.QUESTION_REPORT_GROUP_ID

WHERE
C.QUESTION_IS_ACTIVE_ID = 0 AND C.QUESTION_NOT_REQUIRED_ID = 1
)